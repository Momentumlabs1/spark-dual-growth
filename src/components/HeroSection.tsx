...
const HeroSection = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="relative bg-black overflow-hidden pt-24 sm:pt-28 md:pt-32 pb-10 sm:pb-14 md:pb-16"
    >
      {/* Background Gradient */}
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4">
        ...
        <div className="relative mx-auto mb-6 sm:mb-8 w-[88%] sm:w-[85%] max-w-md md:max-w-lg">
          ...
          >
            ...
            <div className="relative w-full">
              ...
              <div className="relative rounded-2xl overflow-hidden h-[42vh] sm:h-[50vh] md:h-[56vh] lg:h-[62vh]">
                <img
        ...
        >
          ...
          {/* 500+ Kunden */}
          <div className="flex items-center gap-1.5 sm:gap-2 bg-black/70 px-3.5 sm:px-4 py-2 sm:py-2.5 rounded-full border border-nf-red/40">
            <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-nf-red" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                strokeLinecap="round"
