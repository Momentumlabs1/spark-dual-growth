          ...
          <div className="relative">
            ...
            <div className="relative mt-6 sm:mt-7 md:mt-8 space-y-4 sm:space-y-5">
              ...
              <motion.div
                ...
                className="relative z-20 flex flex-wrap items-center justify-center gap-2 sm:gap-2.5 md:gap-3 text-white/90 text-[0.65rem] sm:text-xs md:text-sm"
              >
                {/* 4.9/5 Rating */}
                <div className="flex items-center gap-1.5 bg-black/80 backdrop-blur-sm px-3 sm:px-3.5 py-1.5 sm:py-2 rounded-full border border-nf-red/40 shadow-lg">
                  <svg
                    className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-nf-red flex-shrink-0"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                  </svg>
                  <span className="font-semibold whitespace-nowrap">4.9/5</span>
                </div>
