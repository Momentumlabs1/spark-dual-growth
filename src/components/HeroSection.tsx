...
const HeroSection = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="relative bg-black overflow-hidden pt-24 sm:pt-28 md:pt-32 pb-12 sm:pb-14 md:pb-16"
    >
      {/* Background Gradient */}
            ...
            <div className="relative w-full">
              ...
              <div className="mt-4 sm:mt-5 md:mt-6 space-y-3 sm:space-y-4">
                ...
                <motion.div
                  ...
                  className="flex flex-wrap items-center justify-center gap-2 sm:gap-3 md:gap-4 text-white/90 text-[0.65rem] sm:text-xs md:text-sm max-w-2xl mx-auto"
                >
                  {/* 4.9/5 Rating */}
                  ...
                  <div className="flex items-center gap-1.5 sm:gap-2 bg-black/70 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full border border-nf-red/40">
                    <svg
                      className="w-3 h-3 sm:w-4 sm:h-4 text-nf-red"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
