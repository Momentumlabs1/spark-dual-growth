          ...
          <div className="relative">
            ...
            <div className="relative mt-6 sm:mt-7 md:mt-8 space-y-4 sm:space-y-5">
              ...
              <motion.button
                ...
                className="relative z-10 w-full text-white px-4 py-3.5 sm:px-6 sm:py-4 md:px-10 md:py-5 text-xs sm:text-sm md:text-base lg:text-lg font-bold rounded-xl shadow-2xl border border-white/10 transition-all duration-200 hover:opacity-90 flex items-center justify-center gap-2"
              >
              ...
              {/* TRUST BADGES - GARANTIERT DARUNTER */}
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ delay: 0.9, duration: 0.6 }}
                className="relative z-20 flex flex-wrap items-center justify-center gap-2.5 sm:gap-3 md:gap-3.5 text-white text-[0.7rem] sm:text-xs md:text-sm"
              >
                {/* Top Bewertungen */}
                <div className="flex items-center gap-1.5 bg-gradient-to-br from-nf-red/20 to-nf-red/10 backdrop-blur-sm px-3.5 sm:px-4 py-2 sm:py-2.5 rounded-full border border-nf-red/50 shadow-lg hover:shadow-nf-red/20 transition-all duration-300">
                  <svg
                  ...
                  <span className="font-bold whitespace-nowrap">4.9★ Bewertung</span>
                </div>
                ...
                <div className="flex items-center gap-1.5 bg-gradient-to-br from-nf-red/20 to-nf-red/10 backdrop-blur-sm px-3.5 sm:px-4 py-2 sm:py-2.5 rounded-full border border-nf-red/50 shadow-lg hover:shadow-nf-red/20 transition-all duration-300">
                  ...
                  <span className="font-bold whitespace-nowrap">500+ Erfolgsgeschichten</span>
                </div>
                ...
                <div className="flex items-center gap-1.5 bg-gradient-to-br from-nf-red/20 to-nf-red/10 backdrop-blur-sm px-3.5 sm:px-4 py-2 sm:py-2.5 rounded-full border border-nf-red/50 shadow-lg hover:shadow-nf-red/20 transition-all duration-300">
                  ...
                  <span className="font-bold whitespace-nowrap">Vertraulich & Sicher</span>
                </div>
              </motion.div>
            </div>
          </div>
