...
const HeroSection = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="relative bg-black overflow-hidden pt-20 sm:pt-24 md:pt-28 pb-8 sm:pb-12 md:pb-16"
    >
      {/* Background Gradient */}
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4">
        ...
        <motion.div
          ...
          className="relative z-20 flex flex-wrap items-center justify-center gap-2 sm:gap-3 md:gap-4 text-white/90 text-[0.65rem] sm:text-xs md:text-sm max-w-2xl mx-auto"
        >
          {/* 4.9/5 Rating */}
          <div className="flex items-center gap-1.5 sm:gap-2 bg-black/70 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full border border-nf-red/40">
