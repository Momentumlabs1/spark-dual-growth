...
const HeroSection = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-[#1a0000] to-[#2d0a0a] pt-24 sm:pt-28 md:pt-32 lg:pt-8 xl:pt-12 pb-8 sm:pb-10 lg:pb-6 xl:pb-8">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center">
          ...
          <motion.div
            ...
            className="relative w-full max-w-[340px] sm:max-w-md md:max-w-lg lg:max-w-lg xl:max-w-xl lg:max-h-[350px] xl:max-h-[400px] mb-0 overflow-hidden rounded-2xl"
          >
            <motion.img
            ...
            >
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-3xl xl:text-4xl font-bold leading-tight">
                <span className="text-white">KÖRPER </span>
                <span className="text-[#ff4444]">& GEIST</span>
              </h1>
              <p className="text-white text-base sm:text-lg md:text-xl lg:text-sm xl:text-base mt-2 sm:mt-3 lg:mt-2 font-light">
            ...
            <div className="pointer-events-none absolute inset-x-0 bottom-0 z-20 flex justify-center">
              <motion.button
                ...
                className="pointer-events-auto w-[92%] sm:w-[86%] md:w-[80%] lg:w-[70%] xl:w-[65%] text-white px-5 py-4 sm:px-7 sm:py-5 md:px-12 md:py-6 lg:px-8 lg:py-3 xl:px-10 xl:py-4 text-sm sm:text-base md:text-lg lg:text-sm xl:text-base font-bold rounded-xl shadow-2xl border border-white/10 transition-all duration-200 hover:opacity-90 flex items-center justify-center gap-2 -translate-y-6 sm:-translate-y-7 md:-translate-y-8 lg:-translate-y-5"
              >
