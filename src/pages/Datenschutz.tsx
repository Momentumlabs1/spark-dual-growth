        ...
        <div className="prose prose-xl max-w-none">
          <div className="bg-nf-white border border-nf-gray-200 rounded-lg p-8 md:p-12 shadow-soft">
            ...
            <div className="mb-6">
              ...
              <h3 className="text-lg font-semibold text-nf-black mb-2">Datenerfassung auf dieser Website</h3>
              <h4 className="font-semibold text-nf-black mb-2">Wer ist verantwortlich für die Datenerfassung auf dieser Website?</h4>
              <p className="text-nf-gray-600 mb-4">
              ...
              <h4 className="font-semibold text-nf-black mb-2">Wie erfassen wir Ihre Daten?</h4>
              <p className="text-nf-gray-600 mb-4">
              ...
              <h4 className="font-semibold text-nf-black mb-2">Wofür nutzen wir Ihre Daten?</h4>
              <p className="text-nf-gray-600 mb-4">
              ...
              <h4 className="font-semibold text-nf-black mb-2">Welche Rechte haben Sie bezüglich Ihrer Daten?</h4>
              <p className="text-nf-gray-600 mb-4">
              ...
              <h3 className="text-lg font-semibold text-nf-black mb-2">Analyse-Tools und Tools von Drittanbietern</h3>
              <p className="text-nf-gray-600 mb-4">
            ...
            <h2 className="text-2xl font-semibold text-nf-black mb-4">2. Hosting</h2>
            <div className="mb-6">
              <p className="text-nf-gray-600 mb-4">Wir hosten die Inhalte unserer Website bei folgendem Anbieter:</p>
              
              <h3 className="text-lg font-semibold text-nf-black mb-2">Strato</h3>
              <p className="text-nf-gray-600 mb-4">
              ...
              <p className="text-nf-gray-600 mb-4">
                ...
                <a href="https://www.strato.de/datenschutz/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">
            ...
            <h2 className="text-2xl font-semibold text-nf-black mb-4">3. Allgemeine Hinweise und Pflichtinformationen</h2>
            <div className="mb-6">
              ...
              <h3 className="text-lg font-semibold text-nf-black mb-2">Hinweis zur verantwortlichen Stelle</h3>
            ...
            <h2 className="text-2xl font-semibold text-nf-black mb-4">4. Datenerfassung auf dieser Website</h2>
            <div className="mb-6">
              <h3 className="text-lg font-semibold text-nf-black mb-2">Cookies</h3>
              <p className="text-nf-gray-600 mb-4">
            ...
            <h2 className="text-2xl font-semibold text-nf-black mb-4">5. Soziale Medien</h2>
            <div className="mb-6">
              <h3 className="text-lg font-semibold text-nf-black mb-2">Instagram</h3>
              <p className="text-nf-gray-600 mb-4">
              ...
              <p className="text-nf-gray-600 mb-4">
                ...
                <a href="https://privacycenter.instagram.com/policy/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">
                  https://privacycenter.instagram.com/policy/
                </a>.
              </p>
            </div>

            <h2 className="text-2xl font-semibold text-nf-black mb-4">6. Newsletter</h2>
            <div className="mb-6">
              <h3 className="text-lg font-semibold text-nf-black mb-2">Newsletterdaten</h3>
              <p className="text-nf-gray-600 mb-4">
            ...
            <h2 className="text-2xl font-semibold text-nf-black mb-4">7. Kontakt</h2>
            <div className="mb-6">
