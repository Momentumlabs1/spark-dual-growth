    ...
    <div className="min-h-screen bg-nf-black pt-20 pb-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <p className="text-nf-white/80">für die Erbringung von Dienstleistungen von Niklas Hauger Coaching</p>
        </div>

        <div className="prose prose-xl max-w-none">
          <div className="bg-nf-black/50 border border-nf-white/10 rounded-lg p-8 md:p-12 shadow-soft">
            <h2 className="text-2xl font-semibold text-nf-white mb-4">1. Allgemeines</h2>
            <div className="mb-6">
            ...
            <h2 className="text-2xl font-semibold text-nf-white mb-4">2. Vertragsgegenstand und Leistungsumfang</h2>
            <div className="mb-6">
              <p className="text-nf-white/80 mb-4">
            ...
            <h2 className="text-2xl font-semibold text-nf-white mb-4">3. Mitwirkungspflichten des Auftraggebers</h2>
            <div className="mb-6">
              <p className="text-nf-white/80 mb-4">
            ...
            <h2 className="text-2xl font-semibold text-nf-white mb-4">4. Vergütung</h2>
            <div className="mb-6">
              <p className="text-nf-white/80 mb-4">4.1 Die Vergütung wird individualvertraglich vereinbart.</p>
              <p className="text-nf-white/80 mb-4">
            ...
            <h2 className="text-2xl font-semibold text-nf-white mb-4">5. Haftung / Freistellung</h2>
            <div className="mb-6">
              <p className="text-nf-white/80 mb-4">
            ...
            <h2 className="text-2xl font-semibold text-nf-white mb-4">6. Vertragsdauer und Kündigung</h2>
            <div className="mb-6">
              <p className="text-nf-white/80 mb-4">
            ...
            <h2 className="text-2xl font-semibold text-nf-white mb-4">7. Vertraulichkeit und Datenschutz</h2>
            <div className="mb-6">
              <p className="text-nf-white/80 mb-4">
            ...
            <h2 className="text-2xl font-semibold text-nf-white mb-4">8. Schlussbestimmungen</h2>
            <div className="mb-6">
              <p className="text-nf-white/80 mb-4">8.1 Es gilt das Recht der Bundesrepublik Deutschland unter Ausschluss des CISG.</p>
              <p className="text-nf-white/80 mb-4">
            ...
            <h2 className="text-2xl font-semibold text-nf-white mb-4">9. Informationen zur Online-Streitbeilegung / Verbraucherschlichtung</h2>
            <div className="mb-6">
              <p className="text-nf-white/80 mb-4">
                Die EU-Kommission stellt im Internet unter folgendem Link eine Plattform zur Online-Streitbeilegung bereit: 
                <a href="https://ec.europa.eu/consumers/odr" target="_blank" rel="noopener noreferrer" className="text-nf-red hover:text-nf-red/80 underline ml-1">
              ...
              <p className="text-nf-white/80 mb-4">Unsere E-Mail-Adresse: info@niklashauger.de</p>
            </div>

            <h2 className="text-2xl font-semibold text-nf-white mb-4">Widerrufsbelehrung</h2>
            <div className="mb-6">
              <h3 className="text-lg font-semibold text-nf-white mb-2">Widerrufsrecht für Verbraucher</h3>
              <p className="text-nf-white/80 mb-4">
              ...
              <h3 className="text-lg font-semibold text-nf-white mb-2">Folgen des Widerrufs</h3>
              <p className="text-nf-white/80 mb-4">
